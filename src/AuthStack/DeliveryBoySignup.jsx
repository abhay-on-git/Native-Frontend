...
export default function DeliveryBoySignup({ navigation , route}) {
  ...
  const handleSignup = async () => {
    ...
    try {
      const response = await api.post('/auth/deliveryBoySignup', userdata);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Delivery Boy Signup</Text>
