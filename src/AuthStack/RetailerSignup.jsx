...
export default function RetailerSignup({ navigation , route}) {
  ...
  const handleSignup = async () => {
    ...
    try {
      const response = await api.post('/auth/retailerSignup', userdata);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Retailer Signup</Text>
